...
独立的项目设计文档，适用对象： **Baldur's Gate 3**。
...
- **队伍资源场景** (Party resource scenarios) — 规划模块，尚未实现。
- **存档副本检查点** (Save-copy checkpoints) — 规划模块，尚未实现。
- **版本专属选项说明** (Build-specific option notes) — 规划模块，尚未实现。
